...
const resolveSpec = () => ({
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "HAL 9000-style voice assistant and health endpoints.",
  },
  paths: {
    "/api/chat": {
      post: {
        summary: "Submit chat input and receive direct assistant response",
        tags: ["Chat"],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          ...
          "502": { description: "Upstream gateway/protocol error" },
          "504": { description: "Gateway request timed out" },
          "503": { description: "Session concurrency limit reached" },
        },
      },
    },
    "/api/stt": {
  ...
  components: {
    schemas: {
      ...
      ChatRequest: {
        ...
        properties: {
          ...
          newSession: {
            type: "boolean",
            description:
              "When true, the request starts a new session and ignores provided conversation history.",
          },
          conversationHistory: {
            type: "array",
            maxItems: 20,
      ...
      ChatResponse: {
        type: "object",
        required: ["text", "conversationHistory", "sessionId"],
        properties: {
          text: { type: "string" },
          sessionId: {
            type: "string",
